...
class db {
    ...
    private $user = "root";
    private $pass = "root";
    //private $user = "thietken_banvai";
    //private $pass = "banvai@2013@";
    private $db = "thietken_banvai";
    ...
    public function Login(){
		...
		if ($email=="admin@banvai.vn" && $password=="banvai.vn@2013@") {
			$_SESSION['user_id'] = 'admin@banvai.vn';
