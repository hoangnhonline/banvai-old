...
<div>
    <div>
        <div style="width: 48%;float: left"><h3>Quản lý danh mục : Xem danh sách</h3></div>
        <div style="width: 48%;float: left;text-align: right;padding-top: 20px;text-transform: uppercase;font-size: 15px;font-weight: bold"><a href="index.php?com=danhmuc_add">Thêm danh mục</a></div>
    </div>
            ...
            <table id="drag">
                ...
                <tbody>
                    ...
                    while ($row = mysql_fetch_assoc($sach)) {	
                        ...
                        $i++;                       
                        ?>	
                        <tr id="rows_<?php echo $row['cate_id'];?>">
                            <td><input type="checkbox" name="chon" idDM="<?php echo $row['cate_id'] ?>"></td>                                
                            <td align="center"><?php echo $i; ?></td>                                
                            <td align="left"><?php echo $row['cate_name'] ?></td>                            
                            <td class="action">                                  	
                                <a href="index.php?com=danhmuc_edit&amp;cate_id=<?php echo $row['cate_id'] ?>">
                        ...
                        <?php 
                        $cate_id = $row['cate_id'];
                        $rs_con = $modelCate->getListCate($cate_id);
                        ...
                        <tr id="rows_<?php echo $row_con['cate_id'];?>">
                            ...
                            <td align="center"><?php echo $i; ?></td>                                
                            <td align="left">---- <?php echo $row_con['cate_name'] ?></td>                            
                            <td class="action">                                  	
