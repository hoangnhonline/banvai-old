...
<form action="" method="post" name="form_add_dm_ks">
  <div>
    <div>
      <h3>Quản lý sản phẩm: <?php echo (isset($_GET['article_id']) ? "Cập nhật" : "Thêm mới") ?></h3>
    </div>
    <div class="clr"></div>
  </div>
  <div id="main_admin">
  <div id="main_left">
    <table>
      ...
      <tr class="left">
        <td>Tên sản phẩm</td>
        <td><input type="text" name="product_name" id="product_name" style="width:500px;height:25px" /></td>
      </tr>
      <tr class="left">
        <td>Giá</td>
      ...
      <tr class="left">
        <td>Sản phẩm hot</td>
        <td><input type="checkbox" name="is_hot" id="is_hot" /> HOT (hiện ở trang chủ)</td>
      </tr>
      <tr class="left">
        <td>Hình ảnh</td>
